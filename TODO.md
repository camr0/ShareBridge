...
- Handle `SIGTERM` so container stops complete graceful daemon shutdown.
...
- Add a private GHCR build workflow for the signaling server, following the agent image pattern.
