...
| `LIVE_M4EXIT_AGENT_RECORD_FILE` / `LIVE_M4EXIT_AGENT_RECORD_AGENT_ID` / `LIVE_M4EXIT_EXPECTED_DIRECT_REASON` | — / — / `probe_failed` | case 4 relay fallback (the record must be updated after the request and name the agent) |
